...
`;
    ...
    expect(metaData.tags).toBe('FE,PC');
...
`;
    ...
    expect(blogContent.trim()).toBe(`测试，![IMG_3655](https://raw.githubusercontent.com/lei4519/blog/main/notes/attachments/IMG_3655.jpg)，测试，[ArchWiki](https://wiki.archlinux.org/) //测试，[Vim ESC 键的解决方案](./54)
